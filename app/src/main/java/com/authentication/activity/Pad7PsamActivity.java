...
import android_serialport_api.Pad7PsamAPI;
...
public class Pad7PsamActivity extends Activity implements OnClickListener {
	private Pad7PsamAPI api;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pda7_psam);
