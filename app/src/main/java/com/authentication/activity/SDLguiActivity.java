...
//
// Copyright (c) 2012 Motorola Solutions, Inc.
//-----------------------------------------------------------
...
// === Android UI methods =======================================
	...
	private void mainScreen()
	{
		...
		setContentView(R.layout.sdl_main);		// Inflate our UI from its XML layout description.
	...
	public void surfaceCreated(SurfaceHolder holder)
	{
		try
		{
			Log.e("SDLgui","++++++++surfaceCreated!!!");
			//if (state == STATE_DECODE)  //test preview with display by andrew
	   		//{
	...
	private void doDefaultParams()
   {
	...
	private void doDecode()
	{
		if (setIdle() != STATE_IDLE)		
			return;
		//Log.e("SDLgui","++++++++start doDecode preview!!!");
		//bcr.startPreview();
		//state = STATE_PREVIEW;
		state = STATE_DECODE;
		//vidScreen(true); //test preview with display by andrew
		...
		Log.e("SDLgui","++++++++start doDecode startDecode!!!");
